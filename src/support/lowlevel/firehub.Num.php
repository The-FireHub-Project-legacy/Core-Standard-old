...
abstract class Num {
     ...
     */
    final public static function degreesToRadian (int|float $number):float {
     ...
     */
    final public static function radianToDegrees (int|float $number):float {
     ...
     */
    final public static function exponent (int|float $number):float {
     ...
     */
    final public static function exponent1 (int|float $number):float {
     ...
     */
    final public static function hypotenuseLength (int|float $x, int|float $y):float {
     ...
     */
    final public static function squareRoot (int|float $number):float {
