...
final class Arr {
    ...
    public static function countValues (array $array):array {
        ...
        return array_count_values($array); // @phpstan-ignore return.type
    ...
    public static function fill (mixed $value, int $start_index, int $length):array {
        ...
        return !($length < 0) && !($length >= MAX_32_BIT)
            ...
            : throw new OutOfRangeException()
                ->withLength($length)
                ->appendMessage("Array length must be greater than or equal to zero, but less than 2147483648.");
    ...
    public static function foldKeys (array $array, CaseFolding $case = CaseFolding::LOWER):array {
        ...
        return array_change_key_case($array, $case === CaseFolding::UPPER ? CASE_UPPER : CASE_LOWER); // @phpstan-ignore return.type
    ...
    public static function difference (array $array, array ...$excludes):array {
        ...
        return array_diff($array, ...$excludes); // @phpstan-ignore return.type
    ...
    public static function differenceFunc (array $array, array $excludes, callable $callback):array {
        ...
        return array_udiff($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function differenceKey (array $array, array ...$excludes):array {
        ...
        return array_diff_key($array, ...$excludes); // @phpstan-ignore return.type
    ...
    public static function differenceKeyFunc (array $array, array $excludes, callable $callback):array {
        ...
        return array_diff_ukey($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function differenceAssoc (array $array, array ...$excludes):array {
        ...
        return array_diff_assoc($array, ...$excludes); // @phpstan-ignore return.type
    ...
    public static function differenceAssocFuncValue (array $array, array $excludes, callable $callback):array {
        ...
        return array_udiff_assoc($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function differenceAssocFuncKey (array $array, array $excludes, callable $callback):array {
        ...
        return array_diff_uassoc($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function differenceAssocFuncKeyValue (array $array, array $excludes, callable $callback_value, callable $callback_key):array {
        ...
        return array_udiff_uassoc($array, $excludes, $callback_value, $callback_key); // @phpstan-ignore return.type
    ...
    public static function intersect (array $array, array ...$arrays):array {
        ...
        return array_intersect($array, ...$arrays); // @phpstan-ignore return.type
    ...
    public static function intersectFunc (array $array, array $excludes, callable $callback):array {
        ...
        return array_uintersect($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function intersectKeyFunc (array $array, array $excludes, callable $callback):array {
        ...
        return array_intersect_ukey($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function intersectAssoc (array $array, array ...$arrays):array {
        ...
        return array_intersect_assoc($array, ...$arrays); // @phpstan-ignore return.type
    ...
    public static function intersectAssocFuncValue (array $array, array $excludes, callable $callback):array {
        ...
        return array_uintersect_assoc($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function intersectAssocFuncKey (array $array, array $excludes, callable $callback):array {
        ...
        return array_intersect_uassoc($array, $excludes, $callback); // @phpstan-ignore return.type
    ...
    public static function intersectAssocFuncKeyValue (array $array, array $excludes, callable $callback_value, callable $callback_key):array {
        ...
        return array_uintersect_uassoc($array, $excludes, $callback_value, $callback_key); // @phpstan-ignore return.type
     ...
     * </p>
     * @param null|callable(value-of<TArray>, key-of<TArray>):bool $callback [optional] <p>
     * The callback function to use.
     * If no callback is supplied, all empty and false entries of an array will be removed.
     * </p>
     *
     * @return TArray Filtered array.
     *
    ...
    public static function filter (array $array, ?callable $callback = null):array {
        ...
        return !isset($callback) // @phpstan-ignore return.type
            ? array_filter($array)
     ...
     * </p>
     * @param array<TKey, TValue> ...$replacements<p>
    ...
    public static function replaceRecursive (array $array, array ...$replacements):array {
        ...
        return array_replace_recursive($array, ...$replacements); // @phpstan-ignore return.type
     ...
     *
     * @return list<int|float|string> An array of elements from start to end, inclusive, false otherwise.
     *
     ...
     * range.
     *
     * @return ($number is 1 ? TKey : array<int, TKey>) When picking only one entry, [[Arr#random()]] returns the key
     * for a random entry.
