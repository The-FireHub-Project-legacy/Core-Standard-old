...
final class Data {
    ...
    public static function getType (mixed $value):Type {
        ...
        return match ($internal_type = gettype($value)) {
            ...
            default => throw new TypeUnknownException()->withInternalType(type: $internal_type)
        };
    ...
    public static function setType (mixed $value, Type $type):mixed {
        ...
        switch (true) {
            ...
            default:
                ...
                }) ?: throw new FailedToSetTypeException()->fromValue($value)->toType($type);
    ...
    public static function unserialize (string $data, bool|array $allowed_classes = false, int $max_depth = 4096):mixed {
        ...
        return match ($data) {
            ...
            ) ? $unserialized_data : throw new UnserializeFailedException()->triedWith($data)
        };
