...
final class PHP {
     ...
     * @since 1.0.0
     *
     * @return list<string> Indexed array of all the module names.
     */
     ...
     * </p>
     *
     * @throws \FireHub\Core\Support\Exceptions\PHP\NotValidExtensionException If extension is not valid.
     *
     * @return list<string> Array with all the functions.
     */
     ...
     * @since 1.0.0
     *
     * @return list<string> Array of the names for all files referenced by include and family.
     */
     ...
     * </p>
     *
     * @throws \FireHub\Core\Support\Exceptions\PHP\NotValidConfigurationOptionException If configuration option
     * is not valid.
     *
    ...
    public static function getConfigurationOption (string $option):string {
        ...
        return ini_get($option)
            ?: throw new NotValidConfigurationOptionException()->fromOption($option);
     ...
     * @throws \FireHub\Core\Support\Exceptions\PHP\NotValidExtensionException If extension is not valid.
     *
     * @return array<non-empty-string, array{global_value: null|int|string, local_value: null|int|string, access: \FireHub\Core\Support\Enums\PHP\IniAccessLevel}>
     ...
     * </p>
     *
     * @throws \FireHub\Core\Support\Exceptions\PHP\FailedToSetConfigurationOption If failed to set configuration
     * option.
     *
    ...
    public static function setConfigurationOption (string $option, null|int|float|string|bool $value):true {
        ...
        return ini_set($option, $value) !== false
            ? true
            : throw new FailedToSetConfigurationOption()
                ->fromOption($option)
                ->withValue($value);
     ...
     * @since 1.0.0
     *
     * @throws \FireHub\Core\Support\Exceptions\PHP\FailedToGetProcessIDException If failed to get process ID.
     *
     * @return int Current PHP process ID, or false on error.
     *
    ...
    public static function processID ():int {
        ...
        return ($process_id = getmypid()) !== false
            ? $process_id
            : throw new FailedToGetProcessIDException();
     ...
     * @since 1.0.0
     *
     * @throws \FireHub\Core\Support\Exceptions\PHP\FailedToGetServerAPIException If failed to get server API.
     *
    ...
    public static function serverAPI ():string {
        ...
        return php_sapi_name()
            ?: throw new FailedToGetServerAPIException();
