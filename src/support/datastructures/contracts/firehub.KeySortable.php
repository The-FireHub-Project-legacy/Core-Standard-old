...
/**
 * ### Key sortable data structures can have their values sorted
 * @since 1.0.0
 *
...
interface KeySortable extends Sortable {
    ...
    /**
     * ### Sort keys of the data structure
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\DataStructures\Operation\SortKeys As return.
     *
     * @return \FireHub\Core\Support\DataStructures\Operation\SortKeys<$this>
     */
