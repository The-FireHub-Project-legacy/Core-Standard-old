...
readonly class SequenceRange {
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\Contracts\HighLevel\DataStructures::count() To get the total number of items in
     * the data structure.
     *
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\LowLevel\NumInt::max() To get the maximum between two integers.
     *
    ...
    public function start ():int {
        ...
        return match (true) {
            ...
            default => NumInt::max(0, $this->total + $this->offset)
        };
    ...
    public function end ():int {
        ...
        return match (true) {
            ...
            $start + $this->length > $this->total
                ...
                || DataIs::null($this->length) => $this->total,
